...
function resetar() { // onde o botao C apagará tudo que foi digitado
    document.calc.visor.value = "";
}

function visor() {
    document.calc.visor.value = setEditable(true);
}

function calcular() { // aqui onde será calculado as operações recebidas
